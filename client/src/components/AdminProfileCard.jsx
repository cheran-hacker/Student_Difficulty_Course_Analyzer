...
const AdminProfileCard = ({ user, stats }) => {
    ...
    return (
        <div className="w-full relative py-8 sm:py-12" onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave}>
            ...
            >
                {/* Optimized Glow Aura */}
                <div className="absolute -inset-10 bg-blue-500/5 rounded-[6rem] blur-[40px] opacity-0 group-hover:opacity-100 transition-opacity duration-1000 pointer-events-none" />
                ...
                <div className="relative rounded-[2rem] p-10 lg:p-14 border-[2px] border-slate-200 dark:border-white/10 shadow-[0_40px_80px_rgba(0,0,0,0.08)] dark:shadow-none overflow-hidden transition-all duration-300 transform-gpu backface-visibility-hidden contain-layout">
                    ...
                    <div className="absolute inset-0 opacity-[0.02] dark:opacity-[0.03] pointer-events-none bg-[radial-gradient(#3b82f6_1px,transparent_1px)] [background-size:32px_32px]" />

                    <div className="absolute top-0 right-0 w-32 h-32 border-r-2 border-t-2 border-blue-500/15 pointer-events-none" />
                    <div className="absolute bottom-0 left-0 w-32 h-32 border-l-2 border-b-2 border-blue-500/15 pointer-events-none" />
                            ...
                            <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
                                <div className="relative mb-8">
                                    <motion.div
                                        ...
                                        className="w-40 h-40 sm:w-48 sm:h-48 rounded-[3.5rem] bg-gradient-to-br from-blue-600 via-indigo-500 to-violet-600 p-1 flex items-center justify-center shadow-2xl shadow-blue-500/10 overflow-hidden relative group/avatar cursor-pointer transform-gpu"
                                    >
                                        <div className="w-full h-full bg-white dark:bg-[#0a0c10] rounded-[3.35rem] flex items-center justify-center overflow-hidden transition-colors transform-gpu font-outfit">
                                            <span className="text-8xl font-black text-slate-900 dark:text-white select-none">
                                    ...
                                    <motion.div
                                        ...
                                        className="absolute inset-[-0.5rem] border border-dashed border-blue-500/10 rounded-[3.5rem]"
                                    />
                                </div>
